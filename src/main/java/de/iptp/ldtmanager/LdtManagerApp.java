...
public class LdtManagerApp extends JFrame {
    ...
    public LdtManagerApp() {
        ...
        JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, leftPane, rightPanel);
        splitPane.setResizeWeight(0.58);
        splitPane.setBorder(BorderFactory.createEmptyBorder(4, 8, 8, 8));
    ...
    private void openFile() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Fehler beim Laden: " + ex.getMessage() + "\nTipp: Prüfe Dateiformat/Encoding der LDT-Datei.",
                    "Ladefehler",
